      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
        <header className="rounded-3xl border border-gray-700 bg-gray-900/60 p-10 shadow-2xl shadow-gray-900/40 backdrop-blur">
          <div className="flex items-start justify-between">
            ...
            <Link
              to="/chat"
              className="ml-6 rounded-lg border border-indigo-500/50 bg-indigo-600/20 px-5 py-2.5 text-sm font-medium text-indigo-200 transition hover:bg-indigo-600/30 hover:text-indigo-100"
            >
              💬 Chat
            </Link>
          </div>
